...
die('<span class="badge badge-info"style="background: linear-gradient(to right, #00e9ff, #00f1f3, #00f7de, #00fcc0, #00ff9b);">#Aprovada</span> <span class="badge badge-dark">'.$lista.' '.$bin.'</span>  <span class="text-success"> 𝐂𝐚𝐫𝐝 𝐈𝐬𝐬𝐮𝐞𝐫 𝐃𝐞𝐜𝐥𝐢𝐧𝐞𝐝 𝐂𝐕𝐕. ('.$err.') </span> ➔𝐓𝐢𝐦𝐞: (' . (time() - $time) . 's) <span class="badge badge-info"style="background: linear-gradient(to right, #7610b5, #9900ff, #471cd6, #000dff, #220cc9);"> <a href="https://www.t.me/CYBERSECOFC"> <span class="text-light"> @CYBERSECOFC</a> </span>');
...
die('<span class="badge badge-info"style="background: linear-gradient(to right, #220cc9, #000dff, #5512b3, #9900ff, #7610b5);"> Reprovada </span> <span class="badge badge-dark">'.$lista.' '.$bin.'</span> <span class="text-danger"> 𝐂𝐚𝐫𝐝 𝐑𝐞𝐩𝐫𝐨𝐯𝐚𝐝𝐨. ('.$err.') </span> ➔ Tempo de resposta⏳: (' . (time() - $time) . 's) <span class="badge badge-info"style="background: linear-gradient(to right, #7610b5, #9900ff, #471cd6, #000dff, #220cc9);"> <a href="https://www.t.me/CYBERSECOFC"> <span class="text-light"> @CYBERSECOFC</a> </span>');

}elseif (strpos($Fim, 'HARDVET_VERIFICATION_FAILED')) {



die('<span class="badge badge-info"style="background: linear-gradient(to right, #220cc9, #000dff, #5512b3, #9900ff, #7610b5);"> Reprovada </span> <span class="badge badge-dark">'.$lista.' '.$bin.'</span> <span class="text-danger"> 𝐂𝐚𝐫𝐝 𝐈𝐧𝐞𝐱𝐢𝐬𝐭𝐞𝐧𝐭𝐞. ('.$err.') </span> ➔ Tempo de resposta⏳: (' . (time() - $time) . 's) <span class="badge badge-info"style="background: linear-gradient(to right, #7610b5, #9900ff, #471cd6, #000dff, #220cc9);"> <a href="https://www.t.me/CYBERSECOFC"> <span class="text-light"> @CYBERSECOFC</a> </span>');

} else {

die('<span class="text-danger">Erros</span> ➪ <span class="text-white">'.$lista.'</span> ➪ <span class="text-danger"> 𝐄𝐫𝐫𝐨 𝐚𝐨 𝐫𝐞𝐚𝐥𝐢𝐳𝐚𝐫 𝐫𝐞𝐪𝐮𝐢𝐬𝐢𝐜𝐚𝐨 𝐧𝐚 𝐀𝐦𝐚𝐳𝐨𝐧. </span> ➪ 𝐓𝐢𝐦𝐞: (' . (time() - $time) . 's) ➪ <span class="text-warning">@CYBERSECOFC</span><br>');
